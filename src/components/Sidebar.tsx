      ...
      >
        <div className="flex flex-col h-full p-4">
          ...
          <div className="border-t border-border pt-4 mt-4">
            ...
            <button onClick={signOut} className="w-full mt-2 px-3 py-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-950/50 rounded-md transition-colors text-left flex items-center gap-2">
